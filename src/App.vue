    ...
    <div class="row">
      <div class="col-sm-12">
        <button @click="addItem" class="btn btn-primary">
          <i class="glyphicon glyphicon-plus-sign"></i> Add an item
        </button>
        <button @click="toggleFilter" class="btn btn-outline-primary">
          Toggle Filter
        </button>
        <button @click="togglePicker" class="btn btn-outline-primary">
          Toggle Column Picker
        </button>
        <button @click="toggleSelect" class="btn btn-outline-primary">
          Toggle Select column
        </button>
        <button @click="togglePagination" class="btn btn-outline-primary">
          Toggle Pagination
        </button>
        <button @click="refreshTable" class="btn btn-outline-primary">
          Refresh
        </button>
        <button @click="setNewPageSize" class="btn btn-outline-primary">
          Page Size = 1
        </button>
        <button
          @click="showpageSize = !showpageSize"
          class="btn btn-outline-primary"
        >
          Toggle Page size selecter
        </button>
      </div>
      <br /><br />
      <vue-bootstrap-table
      ...
      values: [
        {
          ...
          name: "Casper Cliff",
          description:
            "Id est rem aliquam animi libero minima. Praesentium ad cum autem quo voluptatum autem ea. Non rerum aliquam atque minima et. Omnis maiores debitis odio consequatur officiis.",
          created_by: 3,
        ...
        },
        {
          ...
          name: "Alfredo Shore",
          description:
            "Beatae deserunt aut voluptas modi repudiandae sit animi. Minima sit quam eligendi non aliquid et excepturi. Fugit reiciendis illo illum eum quidem minus.",
          created_by: 4,
